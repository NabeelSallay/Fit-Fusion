            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <aside class="md:w-1/4 bg-gradient-to-b from-green-600 to-teal-700 text-white p-6 rounded-lg shadow-lg">
                    <div class="sticky top-8">
                        <h2 class="text-2xl font-bold mb-6">Find Your Coach</h2>

                        <!-- Search form -->
                        <form action="{{ route('coaches.search') }}" method="GET" class="mb-6">
                            <div class="flex">
                                <input type="text" name="search" placeholder="Search coaches..." class="w-full px-4 py-2 rounded-l-lg text-gray-700" value="{{ request('search') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <form action="{{ route('coaches.search') }}" method="GET" id="filterForm">
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-medium mb-1">Specialties (comma-separated)</label>
                                        <input type="text" name="specialty" class="w-full px-3 py-2 rounded-lg text-gray-700" value="{{ request('specialty') }}">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium mb-1">Minimum Experience (years)</label>
                                        <input type="number" name="experience" class="w-full px-3 py-2 rounded-lg text-gray-700" value="{{ request('experience') }}">
                                    </div>
                                    <div>
                                    ...
                                    <button type="submit" class="w-full bg-white text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-100 transition duration-200">
                                        Apply Filters
                                    </button>
                        ...
                        <nav class="mt-8 space-y-4">
                            <a href="{{ route('coaches.coach-index') }}" class="block py-2 px-4 rounded-lg hover:bg-white hover:bg-opacity-20 transition duration-200 ease-in-out">All Coaches</a>
                        </nav>
                    </div>
                </aside>
