            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <aside class="lg:w-1/4">
                    <div class="sticky top-8 bg-gradient-to-br from-green-600 to-teal-700 text-white p-6 shadow-xl">
                        <h2 class="text-2xl font-bold mb-6">Coach Dashboard</h2>
                        <nav class="space-y-4">
                            <a href="{{ route('coach.dashboard') }}" class="block py-2 px-4 rounded hover:bg-white hover:bg-opacity-20 transition duration-200">View Connection Requests</a>
                            <a href="{{ route('coach.accepted_requests') }}" class="block py-2 px-4 rounded hover:bg-white hover:bg-opacity-20 transition duration-200">Manage Clients</a>
