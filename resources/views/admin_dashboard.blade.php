                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-lg font-semibold text-gray-700">{{ auth()->user()->where('role', 'client')->count() }}</p>                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="mb-2 text-sm font-medium text-gray-600">Total Coaches</p>
                                <p class="text-lg font-semibold text-gray-700">{{ auth()->user()->where('role', 'coach')->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
