        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-xl overflow-hidden">
                <div class="p-6 sm:p-8">
                    <h2 class="text-2xl font-bold text-white mb-6">Your Accepted Connections</h2>
                    ...
                    @if ($connections->isEmpty())
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">You have no accepted connection requests at the moment.</p>
                        </div>
                    @else
                                ...
                                @foreach ($connections as $connection)
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="#" class="text-indigo-600 hover:text-indigo-900 transition-colors duration-200">Chat</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
